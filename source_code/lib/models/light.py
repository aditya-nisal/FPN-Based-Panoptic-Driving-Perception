...
MCnet_ResNet50_FPN = [    [-1, Focus, [3, 32, 3]],
    [-1, Conv, [32, 64, 3, 2]],
    [-1, BottleneckCSP, [64, 64, 1]],
    [-1, Conv, [64, 128, 3, 2]],
    [-1, BottleneckCSP, [128, 128, 3]],
    ...
    [-1, BottleneckCSP, [256, 256, 3]],
    [-1, Conv, [256, 512, 3, 2]],
    [-1, BottleneckCSP, [512, 512, 3]],

    # ResNet50 FPN
    [-1, FPN, [256, 512, 1024, 2048, 256]],
    [-1, BottleneckCSP, [1024, 512, 1, False]],
    [-1, Conv, [512, 256, 1, 1]],
    [-1, Upsample, [None, 2, 'nearest']],
    [[-1, 6], Concat, [1]],
    [-1, BottleneckCSP, [1024, 256, 1, False]],
    [-1, Conv, [256, 128, 1, 1]],
    [-1, Upsample, [None, 2, 'nearest']],
    [[-1, 4], Concat, [1]],
    [-1, BottleneckCSP, [512, 128, 1, False]],
    [-1, Conv, [128, 128, 3, 2]],
    [[-1, 14], Concat, [1]],
    [-1, BottleneckCSP, [256, 256, 1, False]],
    [-1, Conv, [256, 256, 3, 2]],
   ...
   # Detection head (same as before)
    ...
    [ -1, Upsample, [None, 2, 'nearest']],
    [ [-1,8], Concat, [1]],
    [ -1, BottleneckCSP, [64, 32, 1, False]],
    [ -1, Conv, [32, 16, 3, 1]],
    
# Third FPN
    [ -1, Conv, [128, 512, 3, 2]],
    [ -1, BottleneckCSP, [1024, 1024, 1, False]],
    [ -1, Conv, [1024, 512, 1, 1]],
    [ -1, Upsample, [None, 2, 'nearest']],
    [ [-1,10], Concat, [1]],
    [ -1, BottleneckCSP, [1024, 512, 1, False]],
    [ -1, Conv, [512, 256, 1, 1]],
    [ -1, Conv, [256, 128, 3, 1]],
    [ -1, BottleneckCSP, [128, 128, 1, False]],
...
# Detection head (same as before)
    ...
    [ -2, Conv, [128, 128, 3, 1]],
    [ -2, Conv, [128, 128, 1, 1]],
    [ -2, Conv, [128, num_classes, 1, 1, 'linear']]
